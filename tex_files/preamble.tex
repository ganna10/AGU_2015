...
\setbeamertemplate{headline}{
    ...
    \begin{beamercolorbox}[wd=\paperwidth]{headline}
        \begin{flushleft}
            ...
            \end{tikzpicture}
            \vskip4cm \hskip38mm
            \usebeamercolor{institute in headline}{\color{fg}{\fontsize{50}{45} \selectfont \Institute}\\}
            \vskip5cm \hskip38mm
            \usebeamercolor{title in headline}{\color{fg}{\fontsize{115}{140} \selectfont \postertitle}\\}
            \vskip3cm \hskip38mm
            %\usebeamercolor{title in headline}{\color{fg}{\fontsize{80}{96} \selectfont \subposter}\\}
            %\vskip2.6cm \hskip38mm
            \usebeamercolor{author in headline}{\color{fg}{\fontsize{65}{45} \selectfont \authorname}\\}
            \vskip2cm
        \end{flushleft}
    \end{beamercolorbox}
}
